    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name, field in self.fields.items(): 
            ...
            field_divs.append(Div(
                FloatingField(field_name), css_class='col-md-6')
            ) 
...
class LoginForm(auth_forms.AuthenticationForm):
    def __init__(self, *args, **kwargs):
        ...
        for field_name in self.fields.keys(): 
            field_divs.append(Div(
                FloatingField(field_name), css_class='col-md-12')
            ) 
        self.helper.layout = Layout(
            Div(*field_divs, css_class='row'), 
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in self.fields.keys():
            if field_name in ['image', 'description']:
                ...
                field_divs.append(Div(FloatingField(
                    field_name), css_class='col-md-6')
                ) 
